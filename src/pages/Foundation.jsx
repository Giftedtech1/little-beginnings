  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-16 relative overflow-hidden font-sans"
      ...
      <div className="relative z-10 max-w-2xl w-full text-center">
        ...
        >
          We are building something meaningful. The Little Beginnings Foundation will champion access to inclusive education, support underserved communities, and create lasting impact for children everywhere.
        </motion.p>
